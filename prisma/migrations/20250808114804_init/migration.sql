...
-- CreateTable
CREATE TABLE "public"."ChartConfig" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "key" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ChartConfig_userId_key_key" ON "public"."ChartConfig"("userId", "key");
...
-- AddForeignKey
ALTER TABLE "public"."ChartConfig" ADD CONSTRAINT "ChartConfig_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
